---
title: "Continuous Treatment: Average Dose-Response Function"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Continuous Treatment: Average Dose-Response Function}
...
- $Y = 2X + Z^2 + \varepsilon_Y$, where $\varepsilon_Y \sim N(0, 0.5^2)$
...
```{r adrf, eval = torch::torch_is_installed()}
...
```{r plot, eval = torch::torch_is_installed(), fig.cap = "Estimated vs true ADRF"}
